...
public class ContextualCancellationTokenSource : IDisposable
{
    ...
    public static ContextualCancellationTokenSource CreateLinkedTokenSource(CancellationToken linkedToken)
    {
        ...
        contextualCts.SetContext(linkedToken.GetContext<SparseFileCacheContext>());
    ...
    )
    {
        ...
        contextualCts.SetContext(linkedToken1.GetContext<SparseFileCacheContext>());
        contextualCts.SetContext(linkedToken2.GetContext<SparseFileCacheContext>());
        return contextualCts;
    }
